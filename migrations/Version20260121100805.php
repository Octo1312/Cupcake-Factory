 ...
 */
final class Version20260121100805 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE colors (id INT AUTO_INCREMENT NOT NULL, color VARCHAR(255) NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE colors_cupcake (colors_id INT NOT NULL, cupcake_id INT NOT NULL, INDEX IDX_925020725C002039 (colors_id), INDEX IDX_92502072CDD217C7 (cupcake_id), PRIMARY KEY (colors_id, cupcake_id)) DEFAULT CHARACTER SET utf8mb4');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE colors_cupcake');
